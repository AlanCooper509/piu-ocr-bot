...
exports.COMMAND_SHOW_SUBCOMMAND_TOURNEYS = "tourneys";
exports.COMMAND_SHOW_SUBCOMMAND_TOURNEYS_DESC = "View all server-wide tourneys!";
exports.COMMAND_SHOW_SUBCOMMAND_TOURNEYS_ACTIVE_ONLY_NAME = "active";
exports.COMMAND_SHOW_SUBCOMMAND_TOURNEYS_ACTIVE_ONLY_DESC = "Set as true (default) to only show currently active tourneys";
...
exports.COMMAND_TOURNEY_SUBCOMMAND_CREATE_CHART_TITLE_NAME = "chart_name";
exports.COMMAND_TOURNEY_SUBCOMMAND_CREATE_CHART_TITLE_DESC = "the name of the chart for competition";
exports.COMMAND_TOURNEY_SUBCOMMAND_CREATE_CHART_DIFF_NAME = "difficulty";
exports.COMMAND_TOURNEY_SUBCOMMAND_CREATE_CHART_DIFF_DESC = "examples: D21, S14, SP8, CO-OP";
exports.COMMAND_TOURNEY_SUBCOMMAND_CREATE_START_NAME = "start_date";
exports.COMMAND_TOURNEY_SUBCOMMAND_CREATE_START_DESC = "start of tourney 'yyyy-mm-dd hh:mm:ss'";
exports.COMMAND_TOURNEY_SUBCOMMAND_CREATE_END_NAME = "end_date";
exports.COMMAND_TOURNEY_SUBCOMMAND_CREATE_END_DESC = "end of tourney 'yyyy-mm-dd hh:mm:ss'";
...
exports.COMMAND_TOURNEY_SUBCOMMAND_ALL = "all";
